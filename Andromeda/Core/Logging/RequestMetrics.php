...
{    
    ...
    public static function GetFieldTemplate() : array
    {
        return array_merge(parent::GetFieldTemplate(), array(
            ...
            'peak_memory' => new FieldTypes\IntType(),
            'nincludes' => new FieldTypes\IntType(),
            'nobjects' => new FieldTypes\IntType(),
            'construct_db_reads' => new FieldTypes\IntType(),
            'construct_db_read_time' => new FieldTypes\FloatType(),
            'construct_db_writes' => new FieldTypes\IntType(),
            'construct_db_write_time' => new FieldTypes\FloatType(),
            'construct_code_time' => new FieldTypes\FloatType(),
            'construct_total_time' => new FieldTypes\FloatType(),
            'construct_queries' => new FieldTypes\JSON(),
            'total_db_reads' => new FieldTypes\IntType(),
            'total_db_read_time' => new FieldTypes\FloatType(),
            'total_db_writes' => new FieldTypes\IntType(),
            'total_db_write_time' => new FieldTypes\FloatType(),
            'total_code_time' => new FieldTypes\FloatType(),
            'total_total_time' => new FieldTypes\FloatType(),
