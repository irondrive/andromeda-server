...
class CryptoTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCryptoSecret() : void
    {
        ...
        $this->assertSame(
            ...
            bin2hex($enc = Crypto::EncryptSecret($data, $nonce, $key)));
        
        $this->assertSame($data, Crypto::DecryptSecret($enc, $nonce, $key));
        
        $extra = "extra auth data...";
        
        $this->assertSame(
            "5b394ad117f06e2622974cb5792d1ad41016613a37d973ff34324579b2d4bd0f815a507afc5215",
            bin2hex($enc = Crypto::EncryptSecret($data, $nonce, $key, $extra)));
    ...
    public function testCryptoPublic() : void
    {
        ...
        $this->assertSame(
            ...
            bin2hex($enc = Crypto::EncryptPublic($data, $nonce, $priv1, $pub2)));
    ...
    public function testCryptoAuth() : void
    {
        ...
        $this->assertSame(
            ...
            bin2hex($mac = Crypto::MakeAuthCode($data, $key)));
        
        $this->assertTrue(Crypto::TryCheckAuthCode($mac, $data, $key));
        
        $badmac = (string)hex2bin("abc6a1077b910511bb3f9af766e469726d3e461783f48cf156e8d9966434dbc4");
        $this->assertFalse(Crypto::TryCheckAuthCode($badmac, $data, $key));
