...
CREATE TABLE `a2obj_apps_accounts_authsource_external` (
  ...
  `default_group` char(12) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `a2obj_apps_accounts_config` (
  ...
  `default_group` char(12) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `default_auth` char(8) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
...
CREATE TABLE `a2obj_apps_accounts_resource_client` (
  ...
  `authkey` text CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
...
CREATE TABLE `a2obj_apps_accounts_resource_session` (
  ...
  `master_salt` binary(16) DEFAULT NULL,
  `account` char(12) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `client` char(12) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `a2obj_apps_accounts_resource_usedtoken` (
  ...
  `date_created` double NOT NULL,
  `twofactor` char(12) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  PRIMARY KEY (`id`),
