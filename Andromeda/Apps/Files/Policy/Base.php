 ...
 * Not using an actual table for this, to reduce JOINs...  // TODO POLICY copy over comments from old code as needed
 */
abstract class Base extends BaseObject
{
    ...
    // TODO POLICY add @throws to Check and Count functions
    ...
    public function AddFileCounts(File $file, bool $add = true, bool $noLimit = false) : void
    {
        ...
        if ($this->canTrackItems())
        {
            ...
            if (!$file->onOwnerStorage()) // TODO POLICY seems like we should not do this check? well, for filesystems it should apply, but for the account limit it should not
