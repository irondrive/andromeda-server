...
//TODO timedStats should also catch DatabaseIntegrityException in addition to InsertFailedException
//NOTE that a failure now is permanent due to REPEATABLE READ, rewrite with that in mind
